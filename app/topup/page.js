...
export default function TopUp() {
  ...
  // Read dynamic backend API URL and a pre-filled mobile number from
  // query params (?mobile=...&api=https://...), set when this page is
  // reached automatically after an already-enrolled number is checked
  // on the home page.
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      if (mobileParam) {
        setMobile(normalizeMobile(mobileParam));
      }
    }
  }, []);
  ...
  async function startTopUp(e) {
    ...
    if (!mobileValid || !amountNum || amountNum <= 0) return;
    ...
    try {
      ...
      const rzp = new window.Razorpay({
        ...
        name: "PalmPay",
        description: `Wallet top-up for ${mobileDigits}`,
      ...
      <section className="card">
        ...
        {result === "success" ? (
          <div className="waiting">
            ...
            <p>
              Wallet for <strong>{mobileDigits}</strong> credited successfully.
            </p>
            {newBalance !== null && (
              <p>
          ...
          <>
            <div className="heading">
              <h2>Add funds</h2>
              <p>Enter your mobile number and the amount to add.</p>
            </div>
            ...
            <form onSubmit={startTopUp}>
              <label>
                ...
                <input
                  ...
                  placeholder="Same number used during enrollment"
                  inputMode="numeric"
                  autoComplete="tel"
                  maxLength={16}
                  disabled={paying}
              ...
              <button
                type="submit"
                disabled={!mobileValid || !Number(amount) || paying || !scriptLoaded}
              >
